...
df <-filter(df,Phase=='early',HEM=='left')

# Number of iterations for th   e MCMC sampling
iterations <- 20000
...
cat(stan_code,file = "results_offset/left_insula_early_stancode.stan",sep='\n')
...
save.image(file="results_offset/left_insula_early.RData")
