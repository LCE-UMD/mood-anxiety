...
dataTable <- df %>% select(Subj, ROI, VOX, diff)
...
# the following line does that for you.

priorRBA$prior[1:3] <- "gamma(3.325, 0.5)"
priorRBA$prior[5] <- "gamma(3.325, 0.5)"
